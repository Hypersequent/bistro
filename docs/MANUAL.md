...
This file plans the **45 manual source test cases** (`BD-001…BD-045`) for the QA Sphere project,
...
entries keep their `BD-046…BD-060` IDs, are marked `Automation = Automated`, and point to their
...
- **Test case IDs** — `BD-001 … BD-045` are the manual cases. `BD-046 … BD-060` are the automated
...
- **Requirement** — every case links to exactly one requirement in `REQUIREMENTS.md`. Links use the
  hosted base `https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md`.
...
> - **How to capture:** desktop viewport (~1280×800), live URL, after step 2, bottom-left floating cart icon in frame.
...
| #   | Action                                         | Expected result                                                                                                       |
| --- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| 1   | Click the floating **cart icon** (bottom-left) | The **My cart** modal opens, listing each item with an editable quantity, an **X** remove button, and a **Total** row |
...
- **Folder:** `Navigation & Layout`
- **Requirement:** [LOGO: Logo returns home](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#logo-logo-returns-home)
...
- **Folder:** `Navigation & Layout`
- **Requirement:** [MENULINK: Menu link scrolls to menu](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#menulink-menu-link-scrolls-to-menu)
- **Tags:** `navigation`, `regression`
- **Priority:** Medium
- **Automation:** Manual
- **Precondition:** SP-1 — App open with an empty cart
...
- **Folder:** `Navigation & Layout`
- **Requirement:** [FOOTER: Footer shows QA Sphere link](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#footer-footer-shows-qa-sphere-link)
- **Tags:** `navigation`, `regression`
- **Priority:** Low
- **Automation:** Manual
- **Precondition:** SP-1 — App open with an empty cart
...
#### BD-005 · Hero presents the brand and the View Today's Menu call to action

- **Folder:** `Navigation & Layout`
- **Requirement:** [HERO: Hero presents brand and call to action](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#hero-hero-presents-brand-and-call-to-action)
- **Tags:** `navigation`, `visual`, `smoke`
- **Priority:** Medium
- **Automation:** Manual
- **Precondition:** SP-1 — App open with an empty cart
- **Steps:**
  ...
  | #   | Action                          | Expected result                                                                                                                |
  | --- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
  | 1   | View the hero banner at the top | A full-width banner photo renders behind the hero text (no missing/broken image)                                               |
  | 2   | Read the hero text              | Heading reads **"Bistro Delivery"**; tagline reads _"Elegance of French&Italian Cuisine Delivered Directly to Your Doorstep!"_ |
  | 3   | Click **View Today's Menu**     | The page scrolls to the menu section (`#menu`) without a full reload; the Pizzas menu is in view                               |

  > 🖼️ **IMG-BD005 — Hero banner with brand and call to action**
  >
  > ![IMG-BD005 — Hero banner with brand and call to action](https://qasphere-example.s3.amazonaws.com/bistro-v2/IMG-BD005.webp)
  >
  > - **Shows:** the hero banner photo with the "Bistro Delivery" heading, the tagline, and the "View Today's Menu" button.
  > - **How to capture:** desktop viewport (~1280×800), live URL, top of the home page before any scrolling.
  > - **Expectations:** the banner image, heading, tagline, and button are all legible and fully rendered.
...
- **Steps:**
  ...
  | 4   | Add any item to the cart, open the cart modal, and click **Checkout** | The Checkout page loads with the navbar and footer present        |

#### BD-046 · Navbar links navigate to the correct routes _(manual reproduction of automated BD-046)_
...
- **Requirement:** [RESPONSIVE: Navbar collapses on narrow screens](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#responsive-navbar-collapses-on-narrow-screens)
...
- **Folder:** `Navigation & Layout/Responsive & Mobile Nav`
- **Requirement:** [MOBILE: Pages reflow on mobile](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#mobile-pages-reflow-on-mobile)
...
- **Folder:** `Menu`
- **Requirement:** [MENU: Menu shows tabs with Pizzas active](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#menu-menu-shows-tabs-with-pizzas-active)
...
- **Folder:** `Menu`
- **Requirement:** [IMAGE: Pizzas show images only](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#image-pizzas-show-images-only)
...
#### BD-016 · Menu tab selection resets to Pizzas (not persisted)

- **Folder:** `Menu`
- **Requirement:** [TABRESET: Menu tab selection is not persisted](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#tabreset-menu-tab-selection-is-not-persisted)
- **Tags:** `menu`, `regression`, `edge-case`
- **Priority:** Low
- **Automation:** Manual
- **Precondition:** SP-1 — App open with an empty cart
- **Steps:**
  ...
  | #   | Action                                                                             | Expected result                                                          |
  | --- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
  | 1   | In the menu section, click the **Drinks** tab                                      | The Drinks tab is active and the drinks items are shown                  |
  | 2   | Reload the page (F5) and scroll back to the menu                                   | The **Pizzas** tab is active again; the pizza items are shown            |
  | 3   | Click the **Desserts** tab, then navigate to **About us** and back via **Welcome** | The menu shows the **Pizzas** tab active again (tab choice was not kept) |
  | 4   | After step 3, check the cart badge                                                 | The badge reads **0** — tab switching and resets never changed the cart  |

#### BD-047 · Switching tabs reveals the matching category and active state _(manual reproduction of automated BD-047)_
...
#### BD-048 · Item titles and prices match the menu data per category _(manual reproduction of automated BD-048)_
...
#### BD-017 · Add a menu item to the cart
...
- **Folder:** `Cart`
- **Requirement:** [MODAL: Cart modal opens and closes](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#modal-cart-modal-opens-and-closes)
- **Tags:** `cart`, `regression`
- **Priority:** Medium
- **Automation:** Manual
...
- **Folder:** `Cart`
- **Requirement:** [EMPTY: Empty cart shows a message](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#empty-empty-cart-shows-a-message)
- **Tags:** `cart`, `edge-case`
- **Priority:** Medium
- **Automation:** Manual
- **Precondition:** SP-1 — App open with an empty cart
...
#### BD-049 · Add-to-cart increments the badge by total quantity _(manual reproduction of automated BD-049)_
...
#### BD-050 · Adding the same item twice yields one line with quantity 2 _(manual reproduction of automated BD-050)_
...
#### BD-051 · Line totals and cart total compute correctly _(manual reproduction of automated BD-051)_
...
#### BD-022 · Editing a cart quantity updates line and totals
...
- **Folder:** `Cart/Quantity & Removal`
- **Requirement:** [NEG: Negative quantities are ignored](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#neg-negative-quantities-are-ignored)
- **Tags:** `cart`, `edge-case`
- **Priority:** Medium
- **Automation:** Manual
- **Precondition:** SP-2 — Cart preloaded with a known order
...
#### BD-052 · Setting a quantity greater than zero updates totals _(manual reproduction of automated BD-052)_
...
#### BD-053 · Quantity 0 / empty / non-numeric removes the item _(manual reproduction of automated BD-053)_
...
#### BD-054 · The remove (X) button deletes the line _(manual reproduction of automated BD-054)_
...
#### BD-027 · Empty cart does not expose the Checkout action
...
- **Steps:**
  ...
  | #   | Action                                            | Expected result                                                    |
  | --- | ------------------------------------------------- | ------------------------------------------------------------------ |
  | 1   | Open the cart modal from the empty-cart home page | The cart modal opens and shows that there are no items in the cart |
  | 2   | Inspect the available cart actions                | No usable **Checkout** action is shown while the cart is empty     |
...
- **Folder:** `Checkout`
- **Requirement:** [FORM: Checkout requires name and address](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#form-checkout-requires-name-and-address)
- **Tags:** `checkout`, `regression`
- **Priority:** High
- **Automation:** Manual
- **Precondition:** SP-3 — On the Checkout page with a known order
...
- **Folder:** `Checkout`
- **Requirement:** [PAYMENT: Checkout offers cash and card](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#payment-checkout-offers-cash-and-card)
- **Tags:** `checkout`, `regression`
- **Priority:** Medium
- **Automation:** Manual
- **Precondition:** SP-3 — On the Checkout page with a known order
- **Steps:**
  ...
  | #   | Action                             | Expected result                                                            |
  | --- | ---------------------------------- | -------------------------------------------------------------------------- |
  | 1   | Note the select's initial state    | No payment method is preselected — the select is blank until one is chosen |
  | 2   | Open the **Payment Method** select | It lists exactly **Cash on Delivery** and **Card Payment on Delivery**     |
  | 3   | Select each option in turn         | Either option can be selected and is shown in the closed select            |

#### BD-055 · Empty-cart direct navigation to checkout redirects home _(manual reproduction of automated BD-055)_
...
#### BD-056 · Order summary matches the cart _(manual reproduction of automated BD-056)_
...
#### BD-032 · Place an order through the checkout form
...
- **Steps (after shared steps):**
  ...
  > - **How to capture:** after placing a Cash order from SP-3 (desktop); a tight crop of the
  >   success alert is acceptable — full-viewport context is not required.
...
#### BD-057 · Place an order with Cash on Delivery shows success _(manual reproduction of automated BD-057)_
...
#### BD-058 · Place an order with Card Payment on Delivery shows success _(manual reproduction of automated BD-058)_
...
#### BD-059 · Cart is not cleared after placing an order _(manual reproduction of automated BD-059)_
...
- **Requirement:** [ABOUT: About explains the demo purpose](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#about-about-explains-the-demo-purpose)
...
- **Folder:** `Persistence`
- **Requirement:** [HYDRATE: Malformed cart data resets safely](https://github.com/Hypersequent/bistro/blob/main/docs/REQUIREMENTS.md#hydrate-malformed-cart-data-resets-safely)
...
#### BD-060 · Cart persists across a reload _(manual reproduction of automated BD-060)_
...
- **Manual reproductions of the 15 automated cases** (`BD-046…BD-060`) also appear in §6, filed in
...
- **Shared preconditions** `SP-1/2/3` and **shared steps** `SS-1/2/3/4` are reused throughout:
  39 cases use a shared precondition and 12 use one or more shared steps — comfortably over half,
  ...
  cases. A handful of cases (BD-007…011, BD-045) use **inline** preconditions to showcase that
  option too.
